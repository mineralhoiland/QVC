...
QVCCursor must not own the top-level name ``qvc``. This suite lives as
``qvc_l1`` and imports solvers from QVCCompute (same pattern as ``qvc_bkt``).
"""
...
_DEFAULTS = (
    _HERE.parent,  # sibling of qvc_l1 (this compute/ tree)
