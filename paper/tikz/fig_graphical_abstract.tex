...
\node[box=oiGreen, right=0.55cm of geom] (form) {\textbf{Bessel vacuum}\\$E_{\mathrm{vac}}=\frac{\hbar c_s}{4\pi^2 r}F$\\$F=\Flock$};
...
\node[box=oiGreen!80!black, left=0.55cm of par] (hon) {\textbf{Dynamics}\\truncated GPE + DCE\\live $\Delta[\psi]$};
\draw[arr] (geom) -- (form);
